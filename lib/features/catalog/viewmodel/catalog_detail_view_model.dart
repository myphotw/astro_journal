...
class CatalogDetailViewModel extends ChangeNotifier {
  ...
  CatalogDetailViewModel(
    ...
    List<CatalogObject>? navigationObjects,
        ...
        _objects = List<CatalogObject>.from(

          navigationObjects ?? [object],
  ...
  Future<void> load() async {
    ...
    try {
      ...
      final fetched =
          ...
          await _shootingRecordRepository.getByCelestialObjectId(object.id);
  ...
  Future<void> _loadEquipmentRecommendation() async {
    ...
    _equipmentRecommendation = _equipmentRecommendationService.recommendForObject(
  ...
  Future<ShootingRecord?> savePhotoRecord(
    ...
    try {
      ...
      if (_lastCapturedAt == null ||
          ...
          capturedAt.isAfter(_lastCapturedAt!)) {
      ...
      _records = _records
          ...
          .map(
            ...
            (r) => r.copyWith(
              ...
              isRepresentative: r.id == recordId,
